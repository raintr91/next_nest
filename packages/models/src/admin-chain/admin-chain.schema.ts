...
export const AdminChainCreateRequestSchema = z.object({
...
export const AdminChainSchema = AdminChainCreateRequestSchema.extend({
  id: fields.id,
  created_at: fields.createdAt
})

export const AdminChainReadSchema = AdminChainSchema
