/**
 * aurora-theme: Aurora dashboard theme.
 */
...
export const auroraNav: NavItem[] = [
...
export function renderAuroraDashboardContent(): VNode[] {
  return [
...
export function renderAuroraLoginContent(): VNode[] {
  return [
...
export function renderAuroraSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderAuroraDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Aurora style table.')
    ]),
...
export function renderAuroraCalendarContent(): VNode[] {
  return [
...
export function renderAurora404Content(): VNode[] {
  return [
