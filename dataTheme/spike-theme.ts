/**
 * spike-theme: Spike dashboard theme.
 */
...
export function renderSpikeDashboardContent(): VNode[] {
  return [
...
export function renderSpikeLoginContent(): VNode[] {
  return [
...
export function renderSpikeSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderSpikeDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Spike style table.')
    ]),
...
export function renderSpikeCalendarContent(): VNode[] {
  return [
...
export function renderSpike404Content(): VNode[] {
  return [
