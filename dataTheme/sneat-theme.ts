/**
 * sneat-theme: Sneat dashboard theme.
 */
...
export function renderSneatDashboardContent(): VNode[] {
  return [
...
export function renderSneatLoginContent(): VNode[] {
  return [
...
export function renderSneatSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderSneatDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Sneat style table.')
    ]),
...
export function renderSneatCalendarContent(): VNode[] {
  return [
...
export function renderSneat404Content(): VNode[] {
  return [
