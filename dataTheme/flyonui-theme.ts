/**
 * flyonui-theme: Flyonui dashboard theme.
 */
...
export const flyonuiNav: NavItem[] = [
...
export function renderFlyonuiDashboardContent(): VNode[] {
  return [
...
export function renderFlyonuiLoginContent(): VNode[] {
  return [
...
export function renderFlyonuiSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderFlyonuiDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Flyonui style table.')
    ]),
...
export function renderFlyonuiCalendarContent(): VNode[] {
  return [
...
export function renderFlyonui404Content(): VNode[] {
  return [
