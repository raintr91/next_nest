/**
 * berry-theme: Berry dashboard theme.
 */
...
export function renderBerryDashboardContent(): VNode[] {
  return [
...
export function renderBerryLoginContent(): VNode[] {
  return [
...
export function renderBerrySignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderBerryDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Berry style table.')
    ]),
...
export function renderBerryCalendarContent(): VNode[] {
  return [
...
export function renderBerry404Content(): VNode[] {
  return [
