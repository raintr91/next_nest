/**
 * notus-theme: Notus dashboard theme.
 */
...
export function renderNotusDashboardContent(): VNode[] {
  return [
...
export function renderNotusLoginContent(): VNode[] {
  return [
...
export function renderNotusSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderNotusDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Notus style table.')
    ]),
...
export function renderNotusCalendarContent(): VNode[] {
  return [
...
export function renderNotus404Content(): VNode[] {
  return [
