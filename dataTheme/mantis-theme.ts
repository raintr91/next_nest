/**
 * mantis-theme: Mantis dashboard theme.
 */
...
export const mantisNav: NavItem[] = [
...
export function renderMantisDashboardContent(): VNode[] {
  return [
...
export function renderMantisLoginContent(): VNode[] {
  return [
...
export function renderMantisSignupContent(): VNode[] {
  return [
    h('div', { class: 'mx-auto max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800' }, [
...
export function renderMantisDataTableContent(): VNode[] {
  return [
    h('div', { class: 'mb-4' }, [
      h('h1', { class: 'text-2xl font-bold text-gray-900 dark:text-white' }, 'Basic Tables'),
      h('p', { class: 'text-sm text-gray-500 dark:text-gray-400' }, 'Mantis style table.')
    ]),
...
export function renderMantisCalendarContent(): VNode[] {
  return [
...
export function renderMantis404Content(): VNode[] {
  return [
