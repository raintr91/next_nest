...
import { buildEnrichedPlan } from '../nest-gen/lib/plan.mjs'
import { parseArgs, readSpecFile, toKebab } from '../nest-gen/lib/read-spec.mjs'
...
async function loadRegistry() {
  const raw = await fs.readFile(path.join(repoRoot, 'shared/nest-unit-test.registry.json'), 'utf8')
