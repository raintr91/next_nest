...
- type: inferredFromLegacy
  evidence:
    - /home/vutv/workspace/mairy-backend/resources/views/paginate/custom_paginate.blade.php
    - /home/vutv/workspace/mairy-backend/app/Helpers/helpers.php
  detail: Legacy custom paginate hiển thị previous/next, page numbers xung quanh
    current page và ellipsis.
```
