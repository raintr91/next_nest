...
- type: inferredFromLegacy
  evidence:
    - /home/vutv/workspace/mairy-backend/resources/views/common/show_perpage.blade.php
  detail: Legacy dùng `common.show_perpage` pull-right trên toolbar và
    total/action button trước đó.
```
