...
- **Testcase:** [Admin xem và tìm kiếm danh sách hotel](./hotel-list/testcases/hotel-list.md) · [View hotel list](./hotel-list/testcases/hotel-list.md)
- **Screen:** `# /admin/hotels` · `admin-hotel-list-page`
...
routes:
  - path: /admin/hotels
    ...
    pageTestId: admin-hotel-list-page
testIds:
  module: hotels
filters:
  - name: created_at
...
- type: inferredFromCode
  evidence:
    - /home/vutv/workspace/mairy-backend/resources/views/admin/partials/menu_left.blade.php
    - /home/vutv/workspace/mairy-backend/resources/lang/ja/admin.php
