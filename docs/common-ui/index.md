...
**Design registry (shadcn canonical + shells):** `shared/portal-design.registry.json` — `#shell: DataListPage`, `#widget:`, `#ui:`. Validate: `pnpm portal:registry`. Agent: `.cursor/extracts/portal-design-registry.md`. **Codegen hub:** [PORTAL-CODEGEN.md](/operational/PORTAL-CODEGEN) (`portal:gen` + `portal:unit-gen`). **Promotion sau prototype:** [DESIGN-REGISTRY-PROMOTION.md](/operational/DESIGN-REGISTRY-PROMOTION).
