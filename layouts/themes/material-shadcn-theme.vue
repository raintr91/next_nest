...
<template>
  <div class="min-h-svh bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
    <OrMaterialShadcnNavbar
      :title="pageTitle"
    ...
    <div class="flex overflow-hidden pt-16">
      ...
      <div
        id="main-content"
        class="h-full w-full flex-1 overflow-y-auto bg-gray-100 lg:ml-64 dark:bg-gray-900"
      >
