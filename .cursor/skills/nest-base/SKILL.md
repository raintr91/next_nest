...
description: /nest-base — Nest server patterns ported from Laravel api base.
disable-model-invocation: true
---

# Nest API base

Repo: `server/` · Contracts: `@portal/models`
...
`server/src/modules/{module}/{entity}/` — flat, no nwidart packages.
