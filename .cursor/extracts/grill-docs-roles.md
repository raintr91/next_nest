...
Reference: `common-ui-spec.md`, `common-delete-flow.md`, `common-list-page.spec.yaml`.

## Dev focus

Route path, API contract, filter/column mapping, `codegen`, `#needs-component`, `#wire-only`.  
Reference: `portal-codegen-readiness.md`, `portal-codegen-tags.md`.
